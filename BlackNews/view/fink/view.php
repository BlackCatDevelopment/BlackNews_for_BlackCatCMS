...
// if (
//   blackNews::$template == "viewEntry" &&
//   blackNewsEntry::getOption("catGallery") > 0
// ) {
//   include_once CAT_PATH . "/modules/cc_catgallery/inc/class.catgallery.php";
//   $catGallery = new catGallery(blackNewsEntry::getOption("catGallery"));
//   $parser_data = [
...
// 	*/
//   $parser->setPath(
//     CAT_PATH . "/modules/cc_catgallery/templates/" . $catGallery->getVariant()
//   );
//   $parser->setFallbackPath(
//     CAT_PATH . "/modules/cc_catgallery/templates/default"
//   );
//
//   blackNews::setParserValue("gallery", $parser->get($template, $parser_data));
// }
// blackNews::setParserValue("catIcons", [
//   "default" => "fink-news",
// ]);
?>
